        ...
        <Card className="shadow-sm border-blue-100 bg-blue-50/30">
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <Select value={broadcastData.target_segment} onValueChange={(val) => setBroadcastData({...broadcastData, target_segment: val})}>
            ...
            <div className="space-y-2">
              ...
              <Select value={broadcastData.platform} onValueChange={(val) => setBroadcastData({...broadcastData, platform: val})}>
